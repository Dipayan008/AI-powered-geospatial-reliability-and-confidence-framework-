...
export const XAIPatternRecognitionPanel: React.FC<XAIPatternRecognitionPanelProps> = ({
  ...
  return (
    <div className="glass-panel p-6 md:p-7 rounded-xl border border-[#2A303D] space-y-4 flex flex-col shadow-xl">
      ...
      <div className="glass-panel-accent p-4 md:p-4.5 rounded-xl border border-[#2A303D] space-y-2.5">
        ...
        <p className="text-xs md:text-sm text-[#F4F5F7] leading-relaxed font-sans bg-[#12141C] p-3.5 rounded-xl border border-[#2A303D]">
          "{selectedZone.xaiReasoning}"
        </p>
      </div>

      {/* Maximum Impact Focal Coordinates Banner */}
      <div className="p-3.5 rounded-xl bg-[#14161B] border border-[#38BDF8]/40 space-y-1.5 font-mono">
        ...
        <p className="text-xs text-[#8E95A5] leading-snug pt-1 border-t border-[#2A303D]">
      ...
      <div className="space-y-2.5">
        ...
        <div className="space-y-2 text-xs font-sans">
          {/* Driver 1 */}
          <div className="p-3 rounded-xl bg-[#181C24] border border-[#2A303D] flex items-start space-x-2.5">
            <CheckCircle2 className="w-4 h-4 text-[#10B981] flex-shrink-0 mt-0.5" />
            <div className="space-y-0.5">
              <span className="font-mono font-bold text-white text-xs uppercase block">
                1. Spaceborne SAR Anomaly Signature
              </span>
              <p className="text-[#8E95A5] text-xs leading-snug">
      ...
      <div className="bg-[#181C24] p-3.5 rounded-xl border border-[#2A303D] flex items-start space-x-3">
        <FileSearch className="w-4 h-4 text-[#38BDF8] flex-shrink-0 mt-0.5" />
        <div className="space-y-0.5">
